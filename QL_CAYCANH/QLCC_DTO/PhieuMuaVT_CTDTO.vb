Public Class PhieuMuaVT_CTDTO
    ...
    Private dSoTien As Double


    Public Sub New()

    End Sub
    Public Sub New(strMaPhieu_CT As Integer, strMaPhieu As Integer, iMaVatTu As Integer, strDiaChi As String, iSoLuong_Mua As Integer, dSoTien As Double)
